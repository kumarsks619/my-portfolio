				...
				<form autoComplete='off' onSubmit={handleOnSubmit}>
					<div className='contactForm__group'>
						<div className='contactForm__inputWrapper'>
							...
							<input required type='text' name='name' id='nameID' placeholder="What's your name?" autoComplete='off' value={inputVals.name} onChange={handleOnChange} />
						</div>
						<div className='contactForm__inputWrapper'>
							<label htmlFor='emailID'>Your Email</label>
							<input required type='email' name='email' id='emailID' placeholder="What's your email address?" autoComplete='off' value={inputVals.email} onChange={handleOnChange} />
						</div>
					</div>
					...
					<div className='contactForm__group'>
						<div className='contactForm__inputWrapper'>
							...
							<select required name='service' id='serviceID' value={inputVals.service} onChange={handleOnChange}>
					...
					<div className='contactForm__inputWrapper message'>
						...
						<textarea required name='message' id='messageID' cols='30' rows='10' placeholder='What do yo want to say to me?' value={inputVals.message} onChange={handleOnChange}></textarea>
					</div>
