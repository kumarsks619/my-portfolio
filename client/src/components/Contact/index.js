		...
		<div className='contact'>
			<div className='contact__treeWrapper'>
				<div className='contact__treeSection'>
					<TreeItem name={"Gmail"} iconClass={"far fa-envelope"} link='mailto:kumarsks619@gmail.com' />
					<TreeItem name={"Linkedin"} iconClass={"fab fa-linkedin"} link={SOCIAL.LINKEDIN} />
					<TreeItem name={"GitHub"} iconClass={"fab fa-github"} link={SOCIAL.GITHUB} />
				</div>
				<div className='contact__treeStem'></div>
				<div className='contact__treeSection'>
					<TreeItem name={"Instagram"} iconClass={"fab fa-instagram"} link={SOCIAL.INSTAGRAM} right />
					<TreeItem name={"Facebook"} iconClass={"fab fa-facebook-square"} link={SOCIAL.FACEBOOK} right />
					<TreeItem name={"Twitter"} iconClass={"fab fa-twitter"} link={SOCIAL.TWITTER} right />
				</div>
			</div>
